 ...
 * [ 순서 중요 ]
 * 
 * 1) import java.util.Scanner;  				// Scanner(에서 ctrl + space)클래스를 불러온다.
...
public class InputEx01 {
	...
	public static void main(String[] args) {
		...
		//int      a = 10; 랑 같은 느낌
		Scanner scan = new Scanner(System.in); //코드의 시작부분에서 한번만 작성한다. 
		
		System.out.print("상품 가격을 입력하세요 : " );
		int getProductPrice = scan.nextInt(); //next Int(); 메서드를 통하여 숫자를 입력받는다.
		...
		scan.close(); //scan을 끄는 것은 코드의 맨 마지막에 작성한다.
